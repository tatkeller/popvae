...
if plot:
    subprocess.run("python scripts/plotvae.py --colorby Longitude --latent_coords "+out+'_latent_coords.txt'+' --metadata '+metadata,shell=True)
